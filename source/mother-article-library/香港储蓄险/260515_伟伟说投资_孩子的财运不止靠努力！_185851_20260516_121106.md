...
;
    ...
    if (!window.__second_open__) {
      var videoContentNoEncode = window.a_value_which_never_exists || '孩子的财运不止靠努力！#传承 #遗产 #分红险 #杠杆寿 #香港保险 ';
      var TextContentNoEncode = window.a_value_which_never_exists || '';
      var ContentNoEncode = window.a_value_which_never_exists || '孩子的财运不止靠努力！#传承 #遗产 #分红险 #杠杆寿 #香港保险 ';
      var itemShowType = window.a_value_which_never_exists || '5';
      var content = window.a_value_which_never_exists || '';
      var desc = window.a_value_which_never_exists || '孩子的财运不止靠努力！#传承 #遗产 #分红险 #杠杆寿 #香港保险 ';
