...
;
    ...
    if (!window.__second_open__) {
      var videoContentNoEncode = window.a_value_which_never_exists || '他想明白了，买保险到底难在哪里？#保险 #储蓄险 #分红险 #香港保险 #存款';
      ...
      var desc = window.a_value_which_never_exists || '他想明白了，买保险到底难在哪里？#保险 #储蓄险 #分红险 #香港保险 #存款';
